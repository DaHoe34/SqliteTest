package kr.hs.emirim.dahoe0304.sqlitetest;
...
public class MainActivity extends AppCompatActivity {
    EditText editName, editCount, editNameResult, editCountResut;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editCountResut=(EditText)findViewById(R.id.edit_count_result);
        ...
        butSelect.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Cursor rs=db.rawQuery("select * from idoltable",null); //resultset역할
                String gname="그룹이름"+"\n"+"========"+"\n";
                String gcount="인원수"+"\n"+"========"+"\n";
